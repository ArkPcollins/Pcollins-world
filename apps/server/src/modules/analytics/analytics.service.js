...
export class AnalyticsService {
    async getPlatformMetrics() {
        const [totalUsers, totalProducts, totalOrders, totalProperties, totalSavingsPlans, totalSavingsGroups] = await Promise.all([
    ...
    async getRevenueAnalytics(startDate, endDate) {
        const match = { status: TransactionStatus.SUCCESS };
