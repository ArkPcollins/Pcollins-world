...
// PERSONAL SAVINGS
router.post("/plan", authenticate, asyncHandler(controller.createPlan));
router.get("/plan", authenticate, asyncHandler(controller.getMyPlans));
router.post("/plan/:id/contribute", authenticate, asyncHandler(controller.contributeToPlan));
// GROUP SAVINGS
...
router.post("/plan/:id/break", authenticate, asyncHandler(controller.breakSavingsPlan));
